                    ...
                    <div class="edgtf-column1 edgtf-content-left-from-sidebar">
                        <div class="edgtf-column-inner">
                            <div class="edgtf-blog-holder edgtf-blog-single">
                                <article id="post-283"
                                         class="post-283 post type-post status-publish format-standard has-post-thumbnail hentry category-art tag-music">
                                    <div class="edgtf-post-content">
                                      <?if(isset($content->text)){echo $content->text;}?>
                                        <div style="border: 1px solid #d9d9d9;padding: 10px 20px 10px 20px;">
                                            Добавить <a target="_blank" href="/admin/content/create?type=text&category_id=<?=$meta->id?>" >техт</a>
                                        </div>
                                    </div>
                                </article>
                            </div>
